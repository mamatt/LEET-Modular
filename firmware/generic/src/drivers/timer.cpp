...
void timer::begin()
{
    ...
    Want the timer to run with an interrupt frequency of ~44.1kHz.
    SystemCoreClock = 108MHz
    TIMER6CLK = SystemCoreClock/2431 = 44.4KHz.
    TIMER6 configuration is timing mode, and the timing is 44400/1 = 44400
    ---------------------------------------------------------------------------- */
    ...
    /* TIMER6 configuration */
    timer_initpara.prescaler = 2430; // 108MHz /2431 => 44.4 kHz
    timer_initpara.alignedmode = TIMER_COUNTER_EDGE;
    timer_initpara.counterdirection = TIMER_COUNTER_UP;
    timer_initpara.period = 1; // divide by one
